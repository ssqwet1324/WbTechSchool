...
5. Если хотите протестировать работу ручек то вот пример структуры данных:
```
{
  "user_id": "123",
  "name_event": "Встреча с другом",
  "data_event": "2025-09-20T15:30:00Z",
  "text": "Встретиться в кафе после работы"
}
```